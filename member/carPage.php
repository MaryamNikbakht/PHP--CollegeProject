...
<br>
 <form action="myFavourite.php" method="post">
        <div class="col-md-4 text-center">            
              <input type="checkbox" name="favouritecar"><strong>Your favourite car?</strong>
                 
        </div>
          <div class="col-md-4 text-center">
              <select type="dropdown" class="form-control" name="rateCar" id="rateCar" >
             ...
             <div class="col-md-4 text-center">
                <button type="submit"  name="submit" class="btn btn-info">Submit your favourite car </button>
            </div>
        </form>
...
if (isset($_POST['submit'])) {
  ...
  if (isset($_POST['favouritecar'])) {

     $refUs=$_SESSION['ID'];


$newFav = new Favourite($idcar, $refUs);
